  ...
  return (
    <div className="p-5 pb-24">
      ...
      <section className="mb-6">
        <div className="space-y-3">
          <button
            className="w-full bg-white rounded-3xl p-4 shadow-sm border border-gray-100 hover:border-[#663399]/30 transition-colors flex items-center gap-3"
      ...
      {showPrivacy && (
        <section className="mb-6">
          <h2 className="mb-3">Privacy & Data</h2>
          <PrivacySettings />
        </section>
      )}
