import { TrendingUp, Users, Activity, Bell, FileText, CheckCircle2, ArrowRight, AlertCircle } from "lucide-react";
...
export function Dashboard() {
  ...
  const systemStatus = [
    { service: "API Server", status: "Operational", uptime: "99.98%", color: 'var(--success)' },
    { service: "Database", status: "Operational", uptime: "99.99%", color: 'var(--success)' },
    { service: "Push Notifications", status: "Operational", uptime: "99.95%", color: 'var(--success)' },
    { service: "Analytics Jobs", status: "Operational", uptime: "99.97%", color: 'var(--success)' },
  ];
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              <div
                ...
                style={{ backgroundColor: 'var(--lavender-200)' }}
              >
                <CheckCircle2 className="w-6 h-6" style={{ color: 'var(--lavender-600)' }} />
              </div>
              <div>
                <div className="flex items-center gap-3 mb-1">
                  <span style={{ color: 'var(--lavender-600)' }}>
                    Current Release: v{currentRelease.version}+{currentRelease.buildNumber}
                  </span>
                  <div
                  ...
                  >
                    {currentRelease.environment}
                  </div>
                </div>
                <p className="text-sm" style={{ color: 'var(--warm-500)' }}>
                  Deployed {currentRelease.deployedAt} • All systems operational
                </p>
              </div>
            </div>
            <Link
