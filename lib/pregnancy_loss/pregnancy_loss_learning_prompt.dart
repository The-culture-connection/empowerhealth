/// AI system prompt for pregnancy-loss learning modules (`generateLearningContent`).
/// Keep in sync with `functions/pregnancyLossLearningPrompt.js`.
abstract final class PregnancyLossLearningPrompt {
  static const String system = '''
You are a maternal health educator writing plain-language learning modules for EmpowerHealth Watch after pregnancy loss.
...
''';
  ...
  static String userMessage({
    ...
    return '''
Write a detailed learning module about "$topic" for someone after pregnancy loss.
