  ...
  return (
    <div className="min-h-screen bg-[#faf8f4] dark:bg-[#1a1520] relative overflow-hidden transition-colors duration-500">
      ...
      <div className="relative p-6 pb-24 max-w-2xl mx-auto">
        {/* Greeting - Warm, Human-Centered */}
        <div className="mb-8 mt-4">
          <h1 className="text-[32px] text-[#2d2235] dark:text-[#f5f0f7] font-[450] leading-[1.3] mb-2 tracking-[-0.01em] transition-colors duration-300">Welcome, Mama 🤍</h1>
          <p className="text-[#75657d] dark:text-[#cbbec9] text-[15px] font-light leading-relaxed transition-colors duration-300">You're supported every step of the way.</p>
        </div>
        ...
        {/* Today's Support - Primary Hero Card */}
        <section className="mb-10">
          <h3 className="text-[#663399] dark:text-[#cbbec9] text-[13px] uppercase tracking-[0.08em] mb-4 font-medium transition-colors duration-300">💜 Today's Support</h3>

          {/* Primary Support Card */}
          <Link to="/care-check-in">
            <div className="relative bg-gradient-to-br from-[#f5eee0] via-[#faf8f4] to-[#ebe0d6] dark:from-[#2a2435] dark:via-[#2d2640] dark:to-[#3a3043] rounded-[24px] p-8 shadow-[0_16px_48px_rgba(102,51,153,0.15),_inset_0_1px_0_rgba(255,255,255,0.6)] dark:shadow-[0_16px_56px_rgba(0,0,0,0.4)] border border-[#e8e0f0]/40 dark:border-[#3a3043]/40 transition-all duration-500 hover:shadow-[0_20px_64px_rgba(212,165,116,0.22)] dark:hover:shadow-[0_20px_72px_rgba(0,0,0,0.5)] hover:translate-y-[-2px] cursor-pointer mb-6">
              {/* Warm gold glow */}
              <div className="absolute inset-0 opacity-[0.08] pointer-events-none rounded-[24px] overflow-hidden">
                <div className="absolute top-0 right-0 w-40 h-40 rounded-full bg-[#d4a574] blur-[80px]"></div>
              </div>
              ...
              <div className="relative">
                <div className="flex items-start gap-5 mb-4">
                  <div className="w-14 h-14 rounded-[18px] bg-gradient-to-br from-[#f5eee0] to-[#ebe0d6] dark:from-[#3a3043] dark:to-[#4a3e5d] flex items-center justify-center shadow-[inset_0_2px_10px_rgba(0,0,0,0.08)] transition-all duration-300">
                    <Sparkles className="w-6 h-6 text-[#d4a574] dark:text-[#e0b589] stroke-[1.5]" />
                  </div>
                  <div className="flex-1">
                    <h4 className="text-[#2d2235] dark:text-[#f5f0f7] text-[17px] font-[450] mb-2 tracking-[-0.005em] transition-colors duration-300">Prepare questions for your next visit</h4>
                ...
                <div className="flex items-center gap-2 text-[#9b8ba5] dark:text-[#9b8ba5] text-sm font-light">
                  <span>2 minutes</span>
          ...
          {/* Next Appointment - Secondary Card */}
          <div className="relative bg-[#faf8f4] dark:bg-[#2a2435] rounded-[20px] p-6 shadow-[0_8px_32px_rgba(102,51,153,0.1),_inset_0_1px_0_rgba(255,255,255,0.6)] dark:shadow-[0_8px_40px_rgba(0,0,0,0.4)] border border-[#e8e0f0]/40 dark:border-[#3a3043]/40 transition-all duration-500 hover:shadow-[0_12px_48px_rgba(102,51,153,0.14)] dark:hover:shadow-[0_12px_56px_rgba(0,0,0,0.5)] hover:translate-y-[-2px]">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <p className="text-[#9b8ba5] dark:text-[#9b8ba5] text-xs mb-1 font-light tracking-wide transition-colors duration-300">Next appointment</p>
                ...
                <p className="text-[#75657d] dark:text-[#cbbec9] text-sm font-light transition-colors duration-300">Dr. Maria Johnson</p>
              </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <Link to="/my-visits">
              <div className="relative bg-[#faf8f4] dark:bg-[#2a2435] rounded-[18px] p-5 shadow-[0_8px_32px_rgba(102,51,153,0.1),_inset_0_1px_0_rgba(255,255,255,0.6)] dark:shadow-[0_8px_40px_rgba(0,0,0,0.4)] border border-[#e8e0f0]/40 dark:border-[#3a3043]/40 transition-all duration-500 hover:shadow-[0_12px_48px_rgba(102,51,153,0.14)] dark:hover:shadow-[0_12px_56px_rgba(0,0,0,0.5)] hover:translate-y-[-2px] cursor-pointer">
                ...
                <h4 className="text-[#2d2235] dark:text-[#f5f0f7] text-[15px] font-[450] mb-1 tracking-[-0.005em] transition-colors duration-300">My Visits</h4>
                <p className="text-[#9b8ba5] dark:text-[#9b8ba5] text-xs font-light transition-colors duration-300">Your appointments</p>
              </div>
            </Link>
            ...
            <Link to="/journal">
              <div className="relative bg-[#faf8f4] dark:bg-[#2a2435] rounded-[18px] p-5 shadow-[0_8px_32px_rgba(102,51,153,0.1),_inset_0_1px_0_rgba(255,255,255,0.6)] dark:shadow-[0_8px_40px_rgba(0,0,0,0.4)] border border-[#e8e0f0]/40 dark:border-[#3a3043]/40 transition-all duration-500 hover:shadow-[0_12px_48px_rgba(212,165,116,0.12)] dark:hover:shadow-[0_12px_56px_rgba(0,0,0,0.5)] hover:translate-y-[-2px] cursor-pointer">
                ...
                <div className="relative">
                  ...
                  <h4 className="text-[#2d2235] dark:text-[#f5f0f7] text-[15px] font-[450] mb-1 tracking-[-0.005em] transition-colors duration-300">How I'm Feeling</h4>
                  <p className="text-[#9b8ba5] dark:text-[#9b8ba5] text-xs font-light transition-colors duration-300">Your private space</p>
                </div>
              </div>
            </Link>

            {/* My Birth Preferences */}
            <Link to="/birth-plan-builder">
              <div className="relative bg-[#faf8f4] dark:bg-[#2a2435] rounded-[18px] p-5 shadow-[0_8px_32px_rgba(102,51,153,0.1),_inset_0_1px_0_rgba(255,255,255,0.6)] dark:shadow-[0_8px_40px_rgba(0,0,0,0.4)] border border-[#e8e0f0]/40 dark:border-[#3a3043]/40 transition-all duration-500 hover:shadow-[0_12px_48px_rgba(102,51,153,0.14)] dark:hover:shadow-[0_12px_56px_rgba(0,0,0,0.5)] hover:translate-y-[-2px] cursor-pointer">
                <div className="w-11 h-11 rounded-[14px] bg-gradient-to-br from-[#e8e0f0] to-[#d8cfe5] dark:from-[#3a3043] dark:to-[#4a3e5d] flex items-center justify-center mb-4 shadow-[inset_0_2px_6px_rgba(0,0,0,0.06)] transition-all duration-300">
                  <FileText className="w-5 h-5 text-[#663399] dark:text-[#9d7ab8] stroke-[1.5]" />
                </div>
                <h4 className="text-[#2d2235] dark:text-[#f5f0f7] text-[15px] font-[450] mb-1 tracking-[-0.005em] transition-colors duration-300">My Birth Preferences</h4>
                <p className="text-[#9b8ba5] dark:text-[#9b8ba5] text-xs font-light transition-colors duration-300">What's right for you</p>
              </div>
            </Link>
            ...
            <Link to="/care-plan">
              <div className="relative bg-[#faf8f4] dark:bg-[#2a2435] rounded-[18px] p-5 shadow-[0_8px_32px_rgba(102,51,153,0.1),_inset_0_1px_0_rgba(255,255,255,0.6)] dark:shadow-[0_8px_40px_rgba(0,0,0,0.4)] border border-[#e8e0f0]/40 dark:border-[#3a3043]/40 transition-all duration-500 hover:shadow-[0_12px_48px_rgba(102,51,153,0.14)] dark:hover:shadow-[0_12px_56px_rgba(0,0,0,0.5)] hover:translate-y-[-2px] cursor-pointer">
                ...
                <h4 className="text-[#2d2235] dark:text-[#f5f0f7] text-[15px] font-[450] mb-1 tracking-[-0.005em] transition-colors duration-300">My Next Steps</h4>
        ...
        {/* Community Section */}
        <section>
          <h3 className="text-[#663399] dark:text-[#cbbec9] text-[13px] uppercase tracking-[0.08em] mb-4 font-medium transition-colors duration-300">From the Community 💬</h3>

          <Link to="/community">
            <div className="relative bg-gradient-to-br from-[#faf7f3] via-[#f5f0eb] to-[#f0ead8] dark:from-[#2a2435] dark:via-[#2d2640] dark:to-[#332a3e] rounded-[24px] p-7 shadow-[0_12px_40px_rgba(212,165,116,0.15),_inset_0_1px_0_rgba(255,255,255,0.6)] dark:shadow-[0_12px_48px_rgba(0,0,0,0.4)] border border-[#e8dfc8]/40 dark:border-[#3a3043]/40 transition-all duration-500 hover:shadow-[0_16px_56px_rgba(212,165,116,0.2)] dark:hover:shadow-[0_16px_64px_rgba(0,0,0,0.5)] hover:translate-y-[-2px] cursor-pointer">
              {/* Warm glow */}
              <div className="absolute inset-0 opacity-[0.06] pointer-events-none rounded-[24px] overflow-hidden">
                <div className="absolute top-0 right-0 w-32 h-32 rounded-full bg-[#d4a574] blur-[70px]"></div>
              </div>
              ...
              <div className="relative">
                <div className="flex items-start gap-4 mb-4">
                  ...
                  <div className="flex-1">
                    <h4 className="text-[#2d2235] dark:text-[#f5f0f7] text-[17px] font-[450] mb-2 tracking-[-0.005em] transition-colors duration-300">Welcome to EmpowerHealth Watch</h4>
                    <p className="text-[#75657d] dark:text-[#cbbec9] text-[15px] font-light leading-relaxed transition-colors duration-300">
